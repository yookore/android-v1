...
public class HometownActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtown = (EditText) findViewById(R.id.edtown);
        lvtowns = (ListView) findViewById(R.id.lvtowns);
        ...
        btnsave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(HometownActivity.this, UploadProfilePhotoActivity.class);
        ...
        edtown.addTextChangedListener(new TextWatcher() {
...
//                }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_hometown, menu);
        return true;
    }
